...
MATH_WEIGHT_TRACE_EFFICIENCY_REWARD=${MATH_WEIGHT_TRACE_EFFICIENCY_REWARD:-0.10}
...
# GDPO should be dominated by the main accuracy reward. Keep trace efficiency and
# extractability as logged reward_extra metrics by default, not advantage inputs.
GDPO_ENABLE_MATH_FINAL_ANSWER_REWARD=${GDPO_ENABLE_MATH_FINAL_ANSWER_REWARD:-false}
GDPO_WEIGHT_MATH_FINAL_ANSWER_REWARD=${GDPO_WEIGHT_MATH_FINAL_ANSWER_REWARD:-0.0}
GDPO_ENABLE_MATH_ANSWER_EFFICIENCY_REWARD=${GDPO_ENABLE_MATH_ANSWER_EFFICIENCY_REWARD:-false}
GDPO_WEIGHT_MATH_ANSWER_EFFICIENCY_REWARD=${GDPO_WEIGHT_MATH_ANSWER_EFFICIENCY_REWARD:-0.0}
GDPO_ENABLE_MATH_CONSISTENCY_REWARD=${GDPO_ENABLE_MATH_CONSISTENCY_REWARD:-false}
GDPO_WEIGHT_MATH_CONSISTENCY_REWARD=${GDPO_WEIGHT_MATH_CONSISTENCY_REWARD:-0.0}
GDPO_ENABLE_MATH_EXECUTABLE_UNIT_PASS_RATE_REWARD=${GDPO_ENABLE_MATH_EXECUTABLE_UNIT_PASS_RATE_REWARD:-false}
GDPO_WEIGHT_MATH_EXECUTABLE_UNIT_PASS_RATE_REWARD=${GDPO_WEIGHT_MATH_EXECUTABLE_UNIT_PASS_RATE_REWARD:-0.0}
GDPO_ENABLE_MATH_STEP_ARITHMETIC_VALIDITY_REWARD=${GDPO_ENABLE_MATH_STEP_ARITHMETIC_VALIDITY_REWARD:-true}
GDPO_WEIGHT_MATH_STEP_ARITHMETIC_VALIDITY_REWARD=${GDPO_WEIGHT_MATH_STEP_ARITHMETIC_VALIDITY_REWARD:-0.05}
GDPO_ENABLE_MATH_PREFIX_CONSISTENCY_REWARD=${GDPO_ENABLE_MATH_PREFIX_CONSISTENCY_REWARD:-true}
GDPO_WEIGHT_MATH_PREFIX_CONSISTENCY_REWARD=${GDPO_WEIGHT_MATH_PREFIX_CONSISTENCY_REWARD:-0.02}
GDPO_ENABLE_MATH_TRACE_EFFICIENCY_REWARD=${GDPO_ENABLE_MATH_TRACE_EFFICIENCY_REWARD:-false}
GDPO_WEIGHT_MATH_TRACE_EFFICIENCY_REWARD=${GDPO_WEIGHT_MATH_TRACE_EFFICIENCY_REWARD:-0.0}
GDPO_ENABLE_MATH_ANSWER_EXTRACTABILITY_REWARD=${GDPO_ENABLE_MATH_ANSWER_EXTRACTABILITY_REWARD:-false}
GDPO_WEIGHT_MATH_ANSWER_EXTRACTABILITY_REWARD=${GDPO_WEIGHT_MATH_ANSWER_EXTRACTABILITY_REWARD:-0.0}
...
if [[ "${ADV_ESTIMATOR:-grpo}" == "gdpo" ]]; then
  ...
  if [[ -z "${GDPO_REWARD_KEYS:-}" ]]; then
    ...
    if is_truthy "${MATH_ENABLE_FINAL_ANSWER_REWARD}" && is_truthy "${GDPO_ENABLE_MATH_FINAL_ANSWER_REWARD}"; then
      gdpo_keys+=("math_final_answer_reward")
      gdpo_weights+=("${GDPO_WEIGHT_MATH_FINAL_ANSWER_REWARD}")
    fi
    if is_truthy "${MATH_ENABLE_ANSWER_EFFICIENCY_REWARD}" && is_truthy "${GDPO_ENABLE_MATH_ANSWER_EFFICIENCY_REWARD}"; then
      gdpo_keys+=("math_answer_efficiency_reward")
      gdpo_weights+=("${GDPO_WEIGHT_MATH_ANSWER_EFFICIENCY_REWARD}")
    fi
    if is_truthy "${MATH_ENABLE_CONSISTENCY_REWARD}" && is_truthy "${GDPO_ENABLE_MATH_CONSISTENCY_REWARD}"; then
      gdpo_keys+=("math_consistency_reward")
      gdpo_weights+=("${GDPO_WEIGHT_MATH_CONSISTENCY_REWARD}")
    fi
    if is_truthy "${MATH_ENABLE_EXECUTABLE_UNIT_PASS_RATE_REWARD}" && is_truthy "${GDPO_ENABLE_MATH_EXECUTABLE_UNIT_PASS_RATE_REWARD}"; then
      gdpo_keys+=("math_executable_unit_pass_rate_reward")
      gdpo_weights+=("${GDPO_WEIGHT_MATH_EXECUTABLE_UNIT_PASS_RATE_REWARD}")
    fi
    if is_truthy "${MATH_ENABLE_STEP_ARITHMETIC_VALIDITY_REWARD}" && is_truthy "${GDPO_ENABLE_MATH_STEP_ARITHMETIC_VALIDITY_REWARD}"; then
      gdpo_keys+=("math_step_arithmetic_validity_reward")
      gdpo_weights+=("${GDPO_WEIGHT_MATH_STEP_ARITHMETIC_VALIDITY_REWARD}")
    fi
    if is_truthy "${MATH_ENABLE_PREFIX_CONSISTENCY_REWARD}" && is_truthy "${GDPO_ENABLE_MATH_PREFIX_CONSISTENCY_REWARD}"; then
      gdpo_keys+=("math_prefix_consistency_reward")
      gdpo_weights+=("${GDPO_WEIGHT_MATH_PREFIX_CONSISTENCY_REWARD}")
    fi
    if is_truthy "${MATH_ENABLE_TRACE_EFFICIENCY_REWARD}" && is_truthy "${GDPO_ENABLE_MATH_TRACE_EFFICIENCY_REWARD}"; then
      gdpo_keys+=("math_trace_efficiency_reward")
      gdpo_weights+=("${GDPO_WEIGHT_MATH_TRACE_EFFICIENCY_REWARD}")
    fi
    if is_truthy "${MATH_ENABLE_ANSWER_EXTRACTABILITY_REWARD}" && is_truthy "${GDPO_ENABLE_MATH_ANSWER_EXTRACTABILITY_REWARD}"; then
      gdpo_keys+=("math_answer_extractability_reward")
      gdpo_weights+=("${GDPO_WEIGHT_MATH_ANSWER_EXTRACTABILITY_REWARD}")
    fi
...
PDPO_SAFETY_DUAL_DECAY=${PDPO_SAFETY_DUAL_DECAY:-0.02}
